package com.hechang.codeagent.langgraph4j.tools;
...
import com.hechang.codeagent.langgraph4j.model.enums.ImageCategoryEnum;
...
public class MermaidDiagramTool {
    ...
    /**
     * 生成 Mermaid 架构图
     *  虽然只生成了一张图，但是还是使用list存储，是因为还有其他存储图片的tool，使用tool可以做到统一
     * @param mermaidCode
     * @param description
     * @return
     */
